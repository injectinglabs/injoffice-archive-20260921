...
export const DEMOS: DemoDefinition[] = [
  ...
  { surface: 'docs', title: 'Documents', navTitle: 'Documents', packageName: '@injoffice/docs', description: 'Open a DOCX, select an editable passage, change its text, and download the updated file. The preview shows document content without Word pagination.', runtime: 'Browser', group: 'Create and edit', tasks: ['Edit files', 'Review changes'], formats: ['DOCX'], keywords: ['word', 'text', 'native mutation', 'download'], glyph: 'D', accent: 'blue', recipe: DEMO_RECIPES.docs, ...docs },
