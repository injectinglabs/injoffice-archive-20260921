...
export function nativePptxPreviewStatus(preview:PptxPreview,source?:NativePptxDeck):NativePptxPreviewStatus {
 ...
 if(runtimeGap)reasons.add('Approximate source-frame autofit: saved frame size, layout, and overflow or clipping may differ from PowerPoint. No content-dependent resizing is performed.')
