...
export function NativeDocxTextboxGeometry({bytes,packageDigest}:{bytes:Uint8Array;packageDigest:string}){
 ...
 return <section aria-label="Read-only rectangle textbox geometry">
  <h4>Rectangle textbox preview</h4><p>Inspect explicit DrawingML rectangles, then preview one supplied-font line inside the authored bounds. No page placement, wrapping, autofit or editing is provided.</p>
