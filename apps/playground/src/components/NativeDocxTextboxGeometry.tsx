...
export function NativeDocxTextboxGeometry({bytes,packageDigest}:{bytes:Uint8Array;packageDigest:string}){
 ...
 return <section aria-label="Read-only rectangle textbox geometry">
  <h4>Rectangle textbox preview</h4><p>Inspect explicit DrawingML rectangles, then preview supplied-font text inside the authored bounds, including up to 16 explicit authored lines. No page placement, wrapping, autofit or editing is provided.</p>
