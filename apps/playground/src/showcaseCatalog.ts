...
const AGENT_SHOWCASE: Record<AgentTool, { title: string; description: string; format: DemoFormat; extra: string }> = {
  ...
  docs: {
    title: 'Approve a text edit in a real DOCX',
    description: 'Review a mock-proposed launch-brief text replacement, approve the guarded edit, and download the natively verified DOCX.',
    format: 'DOCX',
    extra: 'docx docs paragraph document word',
  },
  slides: {
    title: 'Approve a text edit in a real PPTX',
    description: 'Review a mock-proposed launch-review text replacement, approve the exact target, and download the natively verified PPTX.',
    format: 'PPTX',
    extra: 'pptx slides deck metric presentation',
  },
  pdf: {
    title: 'Rotate a PDF review page',
    description: 'Review a mock-proposed page rotation, approve the real PDF change, and download the verified file. The preview shows parsed page metadata.',
    format: 'PDF',
