...
The showcase is one continuous page with exactly four live examples: **Sheets, Docs, Slides, and PDF**. The lightweight introduction links to those same workspaces; the former nineteen-item catalogue and extra sidebar sections are gone. Scroll or use the four-item navigation, whose selection follows your position. Passive scrolling updates the URL without adding history entries or moving keyboard focus; explicit links support Back/Forward.
