...
interface NativeDocxQualifiedInlineTextboxV1 {
  drawing_id: string
  run_id: string
  width_millipoints: number
  height_millipoints: number
...
function qualifyNativeDocxInlineTextboxV1(document: NativeDocxDocumentV1, runID: string, drawing: NativeDocxDrawingV1): {ok:true;value:NativeDocxQualifiedInlineTextboxV1}|{ok:false;message:string} {
