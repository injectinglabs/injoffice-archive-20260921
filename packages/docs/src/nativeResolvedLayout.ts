...
import { validNativeDocxAutomaticBorderEvidenceV1, type NativeDocxAutomaticBorderEvidenceV1 } from './nativeAutomaticBorderEvidenceV1.js'
...
export interface NativeDocxResolvedNumberingV1 {
  ...
  start: number
  format: 'decimal' | 'decimalZero' | 'lowerLetter' | 'upperLetter' | 'lowerRoman' | 'upperRoman' | 'bullet' | 'decimalEnclosedCircle' | 'ideographTraditional' | 'ideographZodiac' | 'ideographLegalTraditional' | 'taiwaneseCountingThousand' | 'koreanDigital2'
  text: string
  ...
  counter_values: Array<{ level: number; value: number; format: 'decimal' | 'decimalZero' | 'lowerLetter' | 'upperLetter' | 'lowerRoman' | 'upperRoman' | 'decimalEnclosedCircle' | 'ideographTraditional' | 'ideographZodiac' | 'ideographLegalTraditional' | 'taiwaneseCountingThousand' | 'koreanDigital2' }>
...
export const DOCX_RESOLVED_LAYOUT_V1_BINDING_FIELDS = {
  ...
  RunPropertiesV1: ['font_family', 'east_asia_font_family', 'font_size_half_points', 'kerning_min_size_half_points', 'bold', 'italic', 'underline', 'vertical_alignment', 'color', 'highlight', 'language', 'east_asia_language', 'rtl', 'hidden'],
...
function validateNumbering(value: unknown, path: string, issues: NativeDocxValidationIssue[]): void {
  ...
  enumValue(entry.format, `${path}/format`, ['decimal', 'decimalZero', 'lowerLetter', 'upperLetter', 'lowerRoman', 'upperRoman', 'bullet', 'decimalEnclosedCircle', 'ideographTraditional', 'ideographZodiac', 'ideographLegalTraditional', 'taiwaneseCountingThousand', 'koreanDigital2'], issues)
  ...
  array(entry.counter_values, `${path}/counter_values`, issues, 9).forEach((value, index) => {
    ...
    enumValue(counter.format, `${counterPath}/format`, ['decimal', 'decimalZero', 'lowerLetter', 'upperLetter', 'lowerRoman', 'upperRoman', 'decimalEnclosedCircle', 'ideographTraditional', 'ideographZodiac', 'ideographLegalTraditional', 'taiwaneseCountingThousand', 'koreanDigital2'], issues)
  })
...
function goOrderedRunProperties(properties: NativeDocxResolvedRunPropertiesV1): Record<string, unknown> {
  return Object.fromEntries((['font_family', 'east_asia_font_family', 'font_size_half_points', 'kerning_min_size_half_points', 'bold', 'italic', 'underline', 'vertical_alignment', 'color', 'highlight', 'language', 'east_asia_language', 'rtl', 'hidden'] as const)
