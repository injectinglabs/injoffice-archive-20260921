...
export interface NativeTablePreviewV1 {part:string;sheet_part:string;name:string;ref:string;style:string;header_rows:number;total_rows:number;row_stripes:boolean;column_stripes:boolean;warnings:string[];fill_preview?:{header:string;stripe:string;body:string;header_font_style_ids:number[];fill_style_ids:number[]}}
