...
func TestNativeFootnoteReservationSource(t *testing.T) {
	...
	parts["word/document.xml"] = []byte(`<w:document xmlns:w="` + wns + `"><w:body><w:p><w:pPr><w:keepLines/></w:pPr><w:r><w:t>Prefix paragraph</w:t></w:r></w:p><w:p><w:pPr><w:keepLines/></w:pPr><w:r><w:t>Reference </w:t></w:r><w:r><w:footnoteReference w:id="1"/></w:r></w:p><w:p><w:pPr><w:keepLines/></w:pPr><w:r><w:t>Following paragraph</w:t></w:r></w:p><w:sectPr><w:pgSz w:w="12240" w:h="15840"/><w:pgMar w:top="1440" w:right="1440" w:bottom="13200" w:left="1440" w:header="720" w:footer="720" w:gutter="0"/></w:sectPr></w:body></w:document>`)
	parts["word/footnotes.xml"] = []byte(`<w:footnotes xmlns:w="` + wns + `"><w:footnote w:type="separator" w:id="-1"><w:p><w:r><w:separator/></w:r></w:p></w:footnote><w:footnote w:type="continuationSeparator" w:id="0"><w:p><w:r><w:continuationSeparator/></w:r></w:p></w:footnote><w:footnote w:id="1"><w:p><w:pPr><w:keepLines/></w:pPr><w:r><w:footnoteRef/></w:r><w:r><w:t xml:space="preserve"> The complete footnote stays with its reference and uses a single kept paragraph with source text long enough to wrap.</w:t></w:r></w:p></w:footnote></w:footnotes>`)
	...
	if labels != 1 || kept != 1 || sentinels != 2 || !bytes.Equal(before, source) {
		t.Fatalf("source changed: labels=%d kept=%d sentinels=%d", labels, kept, sentinels)
	}
	if out := os.Getenv("INJOFFICE_FOOTNOTE_RESERVATION_EVIDENCE_DIR"); out != "" {
		...
		if err := os.WriteFile(filepath.Join(out, "footnote-reservation.docx"), source, 0600); err != nil {
			t.Fatal(err)
		}
