...
func NewHandlerWithPreviews(store xlsxhttp.Store, preview DOCXPreviewOptions, pptxPreview PPTXPreviewOptions) http.Handler {
	...
	mux.HandleFunc(DOCXTextboxPreviewPath, func(w http.ResponseWriter, r *http.Request) { handleDOCXPreview(w, r, preview, gate) })
	mux.HandleFunc(DOCXFontSubstitutionPreviewPath, func(w http.ResponseWriter, r *http.Request) { handleDOCXPreview(w, r, preview, gate) })
