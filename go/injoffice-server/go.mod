module github.com/injectinglabs/injoffice/go/injoffice-server

go 1.23.0

require (
	github.com/injectinglabs/injoffice/go/collab v0.0.0
...
replace github.com/injectinglabs/injoffice/go/collab => ../collab
